...
In short — I'm a CS hobbyist with a strong bias toward TypeScript & Go, an habit of breaking things on Arch/Alpine/Windows, 
and not forget one and-off relationship with Rust. Either way — You're welcome to snoop around to through my repos.
